...
gesto_actual = "Ninguno"  # Variable para rastrear el gesto en tiempo real
                ...
                if len(envoltura) > 3:
                    ...
                    if defectos is not None:
                        ...
                        if valles_validos == 0:
                            ...
                            gesto_actual = "DOS_DEDOS"  # Seleccionar pestaña
                            color_texto = (182, 89, 155)
                        elif valles_validos == 2:
                            texto_gesto = "TRES DEDOS"
                            gesto_actual = "TRES_DEDOS"  # Confirmar pestaña
...
# Retorna tanto el estado del riego como el gesto actual detectado
@app.route('/estado')
def obtener_estado():
    global estado_riego, gesto_actual
    return jsonify({
